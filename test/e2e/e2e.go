...
var _ = ginkgo.SynchronizedBeforeSuite(func() []byte {
	...
	if err := framework.WaitForPodsRunningReadyOrSucceeded(c, metav1.NamespaceSystem, int32(framework.TestContext.MinStartupPods), int32(framework.TestContext.AllowedNotReadyNodes), podStartupTimeout, framework.ImagePullerLabels); err != nil {
